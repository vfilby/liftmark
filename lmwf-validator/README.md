...
Validation service for the [LiftMark Workout Format (LMWF)](../docs/MARKDOWN_SPEC.md). Accepts workout markdown and returns structured validation results.
...
See the full [LMWF Markdown Specification](../docs/MARKDOWN_SPEC.md) for the workout format.
