...
3. **Implement the code changes.** Make changes to the Swift app in `mobile-apps/ios/` to match the updated spec. Audit your changes against the spec before moving on.
