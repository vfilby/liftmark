...
final class WorkoutExportIntegrationTests: XCTestCase {
    ...
    private func findProjectRoot() -> URL? {
        ...
        // The source file is at swift-ios/LiftMarkTests/WorkoutExportIntegrationTests.swift
        // Project root is 2 levels up from swift-ios/
        let sourceFile = URL(fileURLWithPath: #filePath)
        var dir = sourceFile.deletingLastPathComponent() // LiftMarkTests/
        dir = dir.deletingLastPathComponent() // swift-ios/
